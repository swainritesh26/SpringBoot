package com.springlearning.product.exception;

import com.springlearning.product.dto.ExceptionResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponseDTO> handleGlobalException(CategoryAlreadyExistsException ex
            , WebRequest webRequest){
        ExceptionResponseDTO exceptionResponseDTO = new ExceptionResponseDTO(
                webRequest.getDescription(false),
